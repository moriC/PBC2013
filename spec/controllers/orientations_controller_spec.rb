  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved orientation as @orientation" do
        ...
        post :create, {:orientation => { "user_id" => "invalid value" }}, valid_session
        assigns(:orientation).should be_a_new(Orientation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested orientation" do
        ...
        Orientation.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => orientation.to_param, :orientation => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the orientation as @orientation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Orientation.any_instance.stub(:save).and_return(false)
        put :update, {:id => orientation.to_param, :orientation => { "user_id" => "invalid value" }}, valid_session
        assigns(:orientation).should eq(orientation)
      end
